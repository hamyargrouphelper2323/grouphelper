...
return 'تبلیغات و لینک گذاشتن ممنوع شداگر کسی اقدام به تبلیغ کرد اخراج میشود'
else
...
return 'قفل لینک و تبلیغات غیرفعال شد'
else
...
local function run(msg, matches)
  ...
  --[[if matches[1] == 'public' then
    ...
    if matches[1] == 'setgpowner' then
      ...
      save_data(_config.moderation.data, data)
      local text = matches[3].." این کاربر مدیر شد"
    ...
    if matches[1] == 'setflood' then 
      ...
      if tonumber(matches[2]) < 5 or tonumber(matches[2]) > 40 then
        return "اشتباه است اعداد انتخوابی باید بین 5 تا 40 باشد"
      end
